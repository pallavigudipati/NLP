...
public class BKTree {
    ...
    public void ConstructBKTree(String dictionaryName)
    ...
    public void Add(String word) {
        ...
        Node curNode = Root;
        DamerauLevenshteinAlgorithm dl = new DamerauLevenshteinAlgorithm(1, 1,
                1, 1);
    ...
    private void RecursiveSearch(Node node, ArrayList<String> rtn, String word,
            int d) {
        this.hit += 1;
        DamerauLevenshteinAlgorithm dl = new DamerauLevenshteinAlgorithm(1, 1,
                1, 1);
    ...
    public List<Integer> getTypoPositions(String[] words) {
        List<Integer> typoPositions = new ArrayList<Integer>();
        for (int i = 0; i < words.length; i++) {
            if (!wordDictionary.containsKey(words[i])) {
                typoPositions.add(i);
            }
        }
        return typoPositions;
    }
}
...
class test {
    public static void main(String argv[]) throws FileNotFoundException,
        ...
        ArrayList<String> phoneticCandidates = getmetaphone.phoneticIndex
                .get(GetMetaPhone.encode(typo));
